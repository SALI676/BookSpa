...
const pool = new Pool({
    user: process.env.DB_USER,       // Use process.env.DB_USER
    host: process.env.DB_HOST,          // Use process.env.DB_HOST
    database: process.env.DB_DATABASE, // Use process.env.DB_DATABASE
    password: process.env.DB_PASSWORD,       // Use process.env.DB_PASSWORD
    port: process.env.DB_PORT,                 // Use process.env.DB_PORT
});
